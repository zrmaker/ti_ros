...
(cl:defmethod target_idx-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_rospkg-msg:target_idx-val is deprecated.  Use ti_mmwave_rospkg-msg:target_idx instead.")
  (target_idx m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RadarScan>)))
  ...
  "a4d09446d2fc17ce80358b29d25af8b6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RadarScan)))
  "Returns md5sum for a message object of type 'RadarScan"
  "a4d09446d2fc17ce80358b29d25af8b6")
